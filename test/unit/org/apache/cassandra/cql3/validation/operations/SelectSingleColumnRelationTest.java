...
public class SelectSingleColumnRelationTest extends CQLTester
{
    ...
    public void testInvalidCollectionNonEQRelation() throws Throwable
    {
        ...
        assertInvalidMessage("Collection column 'b' (set<int>) cannot be restricted by a 'NOT BETWEEN' relation",
                             "SELECT * FROM %s WHERE c = 0 AND b NOT BETWEEN ? AND ?", set(0), set(0));
    ...
    public void testClusteringColumnRelations() throws Throwable
    {
        ...
        assertRows(execute("SELECT * FROM %s WHERE a = ? AND b = ? AND c NOT BETWEEN ? AND ?", "first", 1, 6, 8),
                   row("first", 1, 5, 1));
        ...
        assertInvalidMessage("More than one restriction was found for the start bound on b",
                             "SELECT * FROM %s WHERE a = ? AND b > ? AND b NOT BETWEEN ? AND ?", "first", 6, 3, 2);
    ...
    public void testClusteringColumnRelationsWithClusteringOrder() throws Throwable
    {
        ...
        assertRows(execute("select * from %s where a = ? and b not between ? and ? order by b ASC",
                           "first", 2, 2),
                   row("first", 1, 5, 1),
                   row("first", 3, 7, 3));
        ...
        assertRows(execute("select * from %s where a = ? and b not between ? and ? order by b DESC",
                           "first", 2, 2),
                   row("first", 3, 7, 3),
                   row("first", 1, 5, 1));
    }
    ...
    public void testAllowFilteringWithClusteringColumn() throws Throwable
    {
        ...
        assertInvalidMessage(StatementRestrictions.REQUIRES_ALLOW_FILTERING_MESSAGE,
                             "SELECT * FROM %s WHERE c NOT BETWEEN ? AND ?", 2, 4);
        ...
        assertRows(execute("SELECT * FROM %s WHERE c NOT BETWEEN ? AND ? ALLOW FILTERING", 3, 3),
                   row(1, 2, 1),
                   row(2, 2, 3));
    }
    ...
    public void testAllowFilteringWithIndexedColumnAndStaticColumns() throws Throwable
    {
        ...
        assertRows(execute("SELECT * FROM %s WHERE c = ? AND s NOT BETWEEN ? AND ? ALLOW FILTERING", 1, 3, 2),
                   row(1, 1, 1, 1),
                   row(1, 2, 1, 1));
    ...
    public void testCompositeIndexWithPrimaryKey() throws Throwable
    {
        ...
        assertEmpty(execute("SELECT content FROM %s WHERE time1 = 1 AND time2 NOT BETWEEN 0 AND -1 AND author='foo' ALLOW FILTERING"));
    ...
    public void testMultiplePartitionKeyWithIndex() throws Throwable
    {
        ...
        assertInvalidMessage(StatementRestrictions.REQUIRES_ALLOW_FILTERING_MESSAGE,
                             "SELECT * FROM %s WHERE a = ? AND c = ? AND d NOT BETWEEN ? AND ? AND f = ?", 0, 1, 1, 5, 0);

        assertRows(execute("SELECT * FROM %s WHERE a = ? AND b = ? AND c = ? AND d BETWEEN ? AND ? AND f = ?", 0, 0, 1, 1, 0, 5),
                   row(0, 0, 1, 1, 1, 5));

        assertRows(execute("SELECT * FROM %s WHERE a = ? AND b = ? AND c = ? AND d NOT BETWEEN ? AND ? AND f = ?", 0, 0, 1, 0, 0, 5),
                   row(0, 0, 1, 1, 1, 5));

        assertRows(execute("SELECT * FROM %s WHERE a = ? AND c = ? AND d BETWEEN ? AND ? AND f = ? ALLOW FILTERING", 0, 1, 1, 0, 5),
                   row(0, 0, 1, 1, 1, 5));

        assertRows(execute("SELECT * FROM %s WHERE a = ? AND c = ? AND d NOT BETWEEN ? AND ? AND f = ? ALLOW FILTERING", 0, 1, 0, 0, 5),
                   row(0, 0, 1, 1, 1, 5));
    }
    ...
    public void testWithUnsetValues() throws Throwable
    {
        ...
        assertInvalidMessage("Invalid unset value for column i", "SELECT * from %s WHERE k = 1 AND i NOT BETWEEN ? AND ?", 1, unset());
    }
    ...
    public void testInvalidSliceRestrictionOnPartitionKey() throws Throwable
    {
        ...
        assertInvalidMessage("Multi-column relations can only be applied to clustering columns but was applied to: a",
                             "SELECT * FROM %s WHERE (a) NOT BETWEEN (1) AND (4)");
    }
    ...
    public void testInvalidMulticolumnSliceRestrictionOnPartitionKey() throws Throwable
    {
        ...
        assertInvalidMessage("Multi-column relations can only be applied to clustering columns but was applied to: a",
                             "SELECT * FROM %s WHERE (a, b) NOT BETWEEN (1, 1) AND (4, 5) and a = 1");
    }
    ...
    public void testInvalidColumnNames() throws Throwable
    {
        ...
        assertInvalidMessage("Undefined column name d", "SELECT b AS d FROM %s WHERE d NOT BETWEEN 0 AND 2");
    }
    ...
    public void testInvalidNonFrozenUDTRelation() throws Throwable
    {
        ...
        assertInvalidMessage(msg, "SELECT * FROM %s WHERE b NOT BETWEEN ? AND ?", udt, udt);
    ...
    public void testSliceRestrictionWithNegativeClusteringColumnValues() throws Throwable
    {
        ...
        assertRows(execute("SELECT * from %s WHERE pk = ? AND c NOT BETWEEN ? AND ?", 1, 1, -1),
                   row(1, -2, -2),
                   row(1, 2, 2));
    }
}
